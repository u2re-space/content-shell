//#region ../../../node_modules/@jsquash/jpeg/codec/enc/mozjpeg_enc.js
var Module$1 = (() => {
	...
	return (function(moduleArg = {}) {
		...
		} else wasmBinaryFile = new URL("../../../../../../node_modules/@jsquash/jpeg/codec/enc/mozjpeg_enc.wasm", import.meta.url).href;
		...
		var dynCall_jiji = Module["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module["dynCall_jiji"] = wasmExports["J"])(a0, a1, a2, a3, a4);
		var calledRun;
...
//#endregion
//#region ../../../node_modules/@jsquash/jpeg/meta.js
var defaultOptions = {
	quality: 75,
	baseline: false,
	arithmetic: false,
...
var defaultDecodeOptions = { preserveOrientation: false };
//#endregion
//#region ../../../node_modules/@jsquash/jpeg/utils.js
/**
...
//#endregion
//#region ../../../node_modules/@jsquash/jpeg/encode.js
/**
* Copyright 2020 Google Inc. All Rights Reserved.
* Licensed under the Apache License, Version 2.0 (the "License");
* you may not use this file except in compliance with the License.
...
async function encode(data, options = {}) {
	if (!emscriptenModule$1) init$1();
	const module = await emscriptenModule$1;
	const _options = {
		...defaultOptions,
		...options
	};
	return module.encode(data.data, data.width, data.height, _options).buffer;
}
//#endregion
//#region ../../../node_modules/@jsquash/jpeg/codec/dec/mozjpeg_dec.js
var Module = (() => {
	var _scriptDir = import.meta.url;
	return (function(moduleArg = {}) {
		var Module = moduleArg;
		...
		if (Module["locateFile"]) {
			...
			if (!isDataURI(wasmBinaryFile)) wasmBinaryFile = locateFile(wasmBinaryFile);
		} else wasmBinaryFile = new URL("../../../../../../node_modules/@jsquash/jpeg/codec/dec/mozjpeg_dec.wasm", import.meta.url).href;
		function getBinarySync(file) {
			if (file == wasmBinaryFile && wasmBinary) return new Uint8Array(wasmBinary);
			if (readBinary) return readBinary(file);
			throw "both async and sync fetching of the wasm failed";
		...
		var dynCall_jiji = Module["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module["dynCall_jiji"] = wasmExports["H"])(a0, a1, a2, a3, a4);
		var calledRun;
		dependenciesFulfilled = function runCaller() {
			if (!calledRun) run();
			if (!calledRun) dependenciesFulfilled = runCaller;
...
//#endregion
//#region ../../../node_modules/@jsquash/jpeg/decode.js
/**
* Copyright 2020 Google Inc. All Rights Reserved.
* Licensed under the Apache License, Version 2.0 (the "License");
* you may not use this file except in compliance with the License.
...
async function decode(buffer, options = {}) {
	...
	const result = (await emscriptenModule).decode(buffer, _options.preserveOrientation);
...
//# sourceMappingURL=@jsquash_jpeg.js.map